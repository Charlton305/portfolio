    ...
    <div className="about-me" id="about">
      ...
      <div className="about-me__content-container">
        ...
        <div className="about-me__text-container">
          <p>
            After 16 years in the painting and decorating business, 12 of which
            as a self employed decorator, I decided it was time for a change. I
            quit decorating in december 2022 and spent most of 2023 learning and
          ...
          <p>
            ...
            on a junior developer. I am incredibly driven and self motivated and
            always looking to learn new things and expand my skills and
          ...
          <Link to="/cv" target="_blank" className="CV__button">
            View CV
          </Link>
        </div>
      </div>
